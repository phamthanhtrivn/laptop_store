...
import { addProduct, deleteProduct, getProduct, productList, productListUser, updateProduct } from '../controllers/productControllers.js';
...
productRoute.get('/users', productListUser);
